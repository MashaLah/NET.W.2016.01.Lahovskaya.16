...
namespace Task1.Controllers
{
    public class SellersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SellerID,SellerName,SellingPointID")] Seller seller)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SellerID,SellerName,SellingPointID")] Seller seller)
        {
            if (ModelState.IsValid)
            {
